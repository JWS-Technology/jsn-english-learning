    ...
    return (
        <section className="relative pt-32 pb-44 px-6 bg-[#0F172A] overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto relative z-10 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 px-4 py-2 rounded-full text-[10px] font-black tracking-[0.2em] uppercase mb-8 text-orange-500">
                    <Truck className="w-3.5 h-3.5" /> Doorstep Courier Delivery Available
                </motion.div>
                <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-5xl md:text-8xl font-black text-white leading-[1.05] mb-8">
                    Study Guides <br /> <span className="text-orange-500 italic font-serif font-normal">Delivered.</span>
                </motion.h1>
            </div>
        </section>
    );
